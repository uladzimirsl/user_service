...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        // Enable CORS and disable CSRF - Включить CORS и отключить CSRF
        http = http.cors().and().csrf().disable();

        // Set session management to stateless - Установите управление сеансом без сохранения состояния
        http = http
                .sessionManagement()
                .sessionCreationPolicy(SessionCreationPolicy.STATELESS)
                .and();

        // Set unauthorized requests exception handler - Установить обработчик исключений несанкционированных запросов
        http = http
                .exceptionHandling()
        ...
        // Set permissions on endpoints - Установить разрешения на конечных точках
        ...
        // Add JWT token filter - Добавить фильтр токенов JWT
